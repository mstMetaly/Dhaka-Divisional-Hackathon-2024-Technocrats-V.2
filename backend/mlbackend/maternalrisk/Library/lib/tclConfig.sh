...
# installed.
TCL_PREFIX='D:/Hackathon/Codes/Dhaka-Divisional-Hackathon-2024-Technocrats-V.2/backend/mlbackend/maternalrisk\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Hackathon/Codes/Dhaka-Divisional-Hackathon-2024-Technocrats-V.2/backend/mlbackend/maternalrisk\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Hackathon/Codes/Dhaka-Divisional-Hackathon-2024-Technocrats-V.2/backend/mlbackend/maternalrisk\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Hackathon/Codes/Dhaka-Divisional-Hackathon-2024-Technocrats-V.2/backend/mlbackend/maternalrisk\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Hackathon/Codes/Dhaka-Divisional-Hackathon-2024-Technocrats-V.2/backend/mlbackend/maternalrisk\Library\lib tclstub86.lib'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='D:\bld\tk_1699201897784\work\tcl8.6.13\win\Release_AMD64_VC1929\tclstub86.lib'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='D:/Hackathon/Codes/Dhaka-Divisional-Hackathon-2024-Technocrats-V.2/backend/mlbackend/maternalrisk\Library\lib\tclstub86.lib'
